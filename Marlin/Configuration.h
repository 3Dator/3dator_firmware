...
#define STRING_VERSION_NUMBER "1.1.8"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {110.6,110.6,800,194.25}  // default steps per unit

#define DEFAULT_MAX_FEEDRATE          {350, 350, 30, 100}    // (mm/sec)
